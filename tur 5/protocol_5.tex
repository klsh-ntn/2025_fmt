...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\tau$}{$\omega$}{Роберт Гринштейн}{Егор Лунев, Рома Лисин, Саша Тимошков}

\protocol{1.2}{$\eta$}{$\xi$}{Ваня Адо}{Денис Гохфельд, Вова Федоров, Настя Судницына}

\protocol{2.1}{$\nu$}{$\sigma$}{Сергей Ламзин}{Марина Хмельницкая, Вова Носков}

\protocol{2.2}{$\phi$}{$\psi$}{Боря Демешев}{Тима Спрыжков, Лев Назаров}

\protocol{3.1}{$\alpha$}{$\rho$}{Антон Шейкин}{Олеся Ольшевская, Андрей Трегубович}

\protocol{3.2}{$\beta$}{$\epsilon$}{Миша Красков}{Никита Терентьев, Вика Фонарева} %

\protocol{ВК}{$\lambda$}{$\kappa$}{Ян Шапиро}{Марина Комарова}

\protocol{Горный}{$\chi$}{$\delta$}{Ваня Карлов}{Артем Майдуров}

\protocol{Таежный}{$\theta$}{$\mu$}{Влада Синицына}{Маша Казаринова}

\protocol{Солнечный}{o}{$\gamma$}{Саша Акантьев}{Егор Скурковин}

\protocol{У2.9}{$\pi$}{$\iota$}{Паша Рябенко}{Герман Злобин}
}

...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\tau$}{$\omega$}{Роберт Гринштейн}{Егор Лунев, Рома Лисин, Вова Носков}

\protocol{1.2}{$\eta$}{$\xi$}{Ваня Адо}{Денис Гохфельд, Вова Федоров}

\protocol{2.1}{$\nu$}{$\sigma$}{Сергей Ламзин}{Настя Судницына, Марина Хмельницкая}
...
\protocol{Горный}{$\chi$}{$\delta$}{Иван Карлов}{Миша Торшин}

...
\newcommand{\tour}{Взрослый ФМТ} % номер тура
...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{СуперФМТ}{$\omega$}{Боря Демешев, Роберт Гринштейн, Саша Акантьев, Рома Лисин}{Тима Спрыжков, Марина Хмельницкая, Егор Лунев, Вова Федоров}

\protocol{2.1}{Без НТН}{$\xi$}{Андрей Манзов, Полина Хитрун, Настя Рыбакова, Лиза Зырянова, Ксюша Новикова}{Арина Рябушкина, Соня Бахова, Полина Юхновец, Соня Путинцева, Арина Медведева}

\protocol{3.1}{НТН (обычный)}{$\sigma$}{Вова Носков, Ярик Федулов, Влада Синицына, Паша Рябенко, Миша Красков}{Герман Злобин, Егор Скурковин, Андрей Трегубович, Саша Тимошков, Настя Судницына, Никита Терентьев}
}
...
\begin{center}
   \bf \tour \\
    ...
    \hline
    Матч & Аудитория & Участники\\ 
    \hline
    \blockofjudges
    \end{tabular}
    
    \vspace{2cm}
    Разбейтесь на команды на месте!!!
    \end{center}
}

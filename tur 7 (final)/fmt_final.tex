...
— 12, — ответила зондер Аня Тихомирова. К ней тут же подошла зондер Маша Казаринова.

— Аня называет все числа в 3 раза большими, чем они есть на самом деле, — сказала Маша.

— Так Ламзин съел 4 котлеты? — переспросил Саша Мацуев.

— Маша все числа преуменьшает в 12 раз, — сказала Аня.

Сколько рыбных котлет съел Ламзин за сезон на самом деле?
}
}
...
угаданный ответ - 0 баллов; угадали ответ, но проверили - 1 балл; не учли все числа - 0 баллов
}

\newcommand{\mathB}{
Витя Акинфиев вписал в чёрную-чёрную окружность остроугольный треугольник $ABC$ с углами $\alpha$, $\beta$ и $\gamma$.  
...
\newcommand{\physA}{
    С высокого балкона Антон Шейкин бросает две луковицы с начальными скоростями $v_1 = 8\ \frac{\text{м}}{\text{с}}$ и $v_2 = 5\ \frac{\text{м}}{\text{с}}$ одновременно вдоль вертикальной стены столовой таким образом, что они направлены под углами $\alpha_1 = 70^{o},\ \alpha_2 = 10^{o}$ к горизонту. 
...
\newcommand{\physAsol}{
    ...
    если решили без $g$ правильно - 1 балл; допустили арифметическую ошибку с $g$ - 2 балла

    допустили арифметическую ошибку без $g$ при правильном решении - 0 переход
}

\newcommand{\physB}{
    \begin{minipage}{0.83\linewidth}
        Лиза Микалаускайте подвесила два маленьких заряженных шарика одинаковой массы $m$ на невесомых нитях, как показано на рисунке.
        Определи модуль силы электростатического отталкивания двух шариков. 
        Один шарик висит на нити длины $L$, другой — на нити длины $3L$.
        Угол между нитями равен $\alpha = \frac{\pi}{3}$, ускорение свободного падения, по мнению дирекции, есть $g$.
    \end{minipage}
    \hfill
...
\newcommand{\physBsol}{
    ...
    Третья сторона $\sqrt{9L^2 + L^2 + 3L^2} = L\sqrt{13}$. Высота к этой стороне $h = \frac{3\sqrt{3}}{2\sqrt{13}}L$. Из правила моментов отностильно точки подвеса
    \begin{equation*}
        mgL\sin \phi + F h = 3mg L\sin(\alpha - \phi) + F h \Rightarrow 3\sin (\alpha - \phi) = \sin \alpha \Rightarrow \sin \phi = \sqrt{\frac{27}{52}}
    \end{equation*}
    ...
    правильно построена модель (моменты, силы) - 1 балл; начали искать угол $\phi$ - 2 балла

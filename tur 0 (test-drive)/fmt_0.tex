...
\newcommand{\anecdote}{Рубрика \textbf{анекдот} тура
    \begin{displayquote} 
        {\it Бабушка переходила дорогу не на тот свет, а попала на тот}
    \end{displayquote}
    } % сюда пишем анекдот
...
\newcommand{\hardmath}{
    Найди приведённый квадратный трёхчлен ($x^2 + px + q$) такой, что его нестаршие коэффициенты отличаются на $2$ и они положительные, а корни отличаются в $2$ раза.
}
...
\newcommand{\easyphys}{
    (\textbf{тур 1, 2010 год (35 сезон)}) Плотность сухого песка равна $\rho_1$, а плотность очень влажного песка, насыщенного водой, равна $\rho_2$. Плотность воды равна $\rho_0$. Найди среднюю плотность песчинок в смеси воды и песка.
}
...
\newcommand{\soleasyphys}{
    ...
    Ответ: $\rho_{\text{ср}} = \frac{m_{\text{пес}}}{V_{\text{пес}} + V_{\text{в}}} = \rho_1 \frac{\rho_0 - \rho_2}{\rho_0 - \rho_1}$
}

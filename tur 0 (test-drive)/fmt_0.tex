...
\newcommand{\hardmath}{
    Найди все приведённые квадратные трёхчлены ($x^2 + px + q$) такие, что его нестаршие коэффициенты отличаются на $2$ и они положительные, а корни отличаются в $2$ раза.
}

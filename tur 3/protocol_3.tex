...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\alpha$}{$\eta$}{Антон Шейкин}{Дмитрий Федченко, Роберт Гринштейн, Вова Носков}

\protocol{1.2}{$\epsilon$}{$\tau$}{Сережа Ламзин}{Паша Рябенко, Настя Судницына}

\protocol{2.1}{$\omega$}{$\beta$}{Рома Лисин}{Саша Тимошков, Денис Гохфельд}

\protocol{2.2}{$\gamma$}{$\nu$}{Ваня Адо}{Егор Лунев, Лев Назаров}

\protocol{3.1}{$\xi$}{$\rho$}{Саша Акантьев}{Миша Торшин, Андрей Трегубович}

\protocol{3.2}{$\sigma$}{$\psi$}{Тима Спрыжков}{Ольга Володько, Андрей Манзов} %

\protocol{ВК}{$\lambda$}{o}{Ян Шапиро}{Вова Федоров, Герман Злобин}

\protocol{Горный}{$\phi$}{$\chi$}{Влада Синицына}{Егор Скурковин, Маша Казаринова}

\protocol{Таежный}{$\delta$}{$\pi$}{Иван Карлов}{Никита Терентьев, Вика Фонарева}

\protocol{Солнечный}{$\theta$}{$\iota$}{Миша Красков}{Олеся Ольшевская}

\protocol{Столовая}{$\mu$}{$\kappa$}{Марина Хмельницкая}{Вика Луковская}
}

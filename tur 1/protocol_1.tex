...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\eta$}{$\psi$}{Сережа Ламзин}{Денис Гохфельд, Лев Назаров}

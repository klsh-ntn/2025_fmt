...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\eta$}{$\psi$}{Егор Лунев}{Егор Скурковин, Вика Фонарева}

\protocol{1.2}{$\alpha$}{$\beta$}{Миша Красков}{Влада Синицына, Маша Казаринова}

\protocol{2.1}{$\nu$}{$\rho$}{Сережа Ламзин}{Денис Гохфельд, Герман Злобин}

\protocol{2.2}{$\xi$}{$\gamma$}{Тима Спрыжков}{Андрей Трегубович}

\protocol{3.1}{$\pi$}{$\sigma$}{Роберт Гринштейн}{Саша Акантьев}

\protocol{3.2}{$\delta$}{$\theta$}{Ян Шапиро}{Ольга Володько, Вова Федоров} %

\protocol{ВК}{$\iota$}{$\tau$}{Ваня Адо}{Дмитрий Федченко, Лев Назаров}

\protocol{беседка мед-1}{$\mu$}{o}{Рома Лисин}{Паша Рябенко}

\protocol{беседка 1-2}{$\epsilon$}{$\lambda$}{Марина Хмельницкая}{Никита Терентьев, Вова Носков}

\protocol{беседка 2-3}{$\kappa$}{$\phi$}{Антон Шейкин}{Саша Тимошков, Герман Злобин}

\protocol{столовая}{$\xi$}{$\omega$}{Настя Судницына}{Миша Торшин}
}

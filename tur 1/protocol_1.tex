...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\eta$}{$\psi$}{Сережа Ламзин}{Денис Гохфельд, Иван Карлов, Лев Назаров}

\protocol{1.2}{$\alpha$}{$\beta$}{Роберт Гринштейн}{Марина Хмельницкая, Андрей Трегубович, Ольга Володько}

\protocol{2.1}{$\nu$}{$\rho$}{Рома Лисин}{Миша Торшин, Никита Терентьев}

\protocol{2.2}{$\xi$}{$\gamma$}{Миша Красков}{Дмитрий Федченко, Саша Тимошков}

\protocol{3.1}{$\pi$}{$\sigma$}{Ян Шапиро}{Паша Рябеко, Влада Синицына}

\protocol{3.2}{$\delta$}{$\theta$}{Антон Шейкин}{Егор Лунев, Влада Синицына} %

\protocol{ВК}{$\iota$}{$\tau$}{Вика Луковская}{Вика Фонарева, Егор Скурковин }

\protocol{Горный}{$\mu$}{o}{Ваня Адо}{Герман Злобин}

\protocol{Таежный}{$\epsilon$}{$\lambda$}{Настя Судницына}{Тима Спрыжков}

\protocol{Солнечный}{$\kappa$}{$\phi$}{Саша Акантьев}{Вова Носков}

\protocol{Столовая}{$\xi$}{$\omega$}{Вова Федоров}{Маша Казаринова}
}

...
\newcommand{\easymath}{
    Ламзин называет день “счастливым”, если все $6$ цифр его записи различны. Например, $13.07.25$ — счастливый день, а $23.07.25$ — нет. Сколько всего счастливых дней у Сережи в $2025$ году?
}


\newcommand{\soleasymath}{
    Грубым перебором по месяцам $xx.01.25, \dots, xx.10.25$ перебираем все случаи.
...
\newcommand{\hardmath}{
    В прямоугольнике $ABCD$ со сторонами $AB = a, BC = b$ проведены биссектрисы всех прямых углов до взаимного пересечения. Найди площадь четырехугольника, образованного биссектрисами.
}
\newcommand{\solhardmath}{

...
\newcommand{\solhardmath}{
    ...
    $$
    1 балл - доказал, что $KLSH$ -- прямоугольник; 2 балл - доказал, что квадрат, но ошибка в счете стороны.
}
...
\newcommand{\solhardphys}{
   ...
   $$
   v_{\text{ср}} = \frac{S}{\frac{S}{3v_1} + \frac{S}{3v_2} + \frac{S}{3v_3}} = \frac{3}{\frac{1}{v_1} + \frac{1}{v_1} + \frac{1}{v_3}} = \frac{3}{\frac{1}{6} +\frac{1}{9} + \frac{1}{18}} = 9\frac{км}{ч}
   $$

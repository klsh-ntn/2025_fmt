...
\newcommand{\easyphys}{
    (\textbf{тур 2, 1990 год (15 сезон)}) На пробку массой $m_{\text{п}} = 1.7$ г наматывают проволоку из алюминия. Плотность пробки $\rho_{\text{п}} = 0.5 \cdot 10^3\ \frac{\text{кг}}{\text{м}^3}$, алюминия $\rho_{\text{ал}} = 2.7 \cdot 10^3\ \frac{\text{кг}}{\text{м}^3}$, воды $\rho = 10^3\ \frac{\text{кг}}{\text{м}^3}$. Определить минимальную массу алюминиевой проволоки $m_{\text{ал}}$, которую необходимо намотать на пробку, чтобы она вместе с пробкой погрузилась в воду.
}

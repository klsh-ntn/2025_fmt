...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\alpha$}{$\gamma$}{Вика Луковская}{Настя Судницына, Ольга Володько, Вова Федоров}

\protocol{1.2}{$\eta$}{$\nu$}{Егор Лунев}{Герман Злобин, Рома Лисин}

\protocol{2.1}{$\sigma$}{$\epsilon$}{Миша Красков}{Дмитрий Федченко, Тима Спрыжков}

\protocol{2.2}{o}{$\tau$}{Ваня Карлов}{Вика Фонарева, Саша Тимошков}

\protocol{3.1}{$\phi$}{$\omega$}{Роберт Гринштейн}{Лена Абакумова, Лев Назаров}

\protocol{3.2}{$\delta$}{$\beta$}{Сережа Ламзин}{Олеся Ольшевская, Паша Рябенко}

\protocol{ВК}{$\theta$}{$\xi$}{Саша Акантьев}{Влада Синицына, Вова Носков}

\protocol{Горный}{$\pi$}{$\rho$}{Ваня Адо}{Марина Хмельницкая}

\protocol{Таежный}{$\psi$}{$\iota$}{Ян Шапиро}{Маша Казаринова}

\protocol{Солнечный}{$\lambda$}{$\mu$}{Антон Шейкин}{Андрей Трегубович}

\protocol{Столовая}{$\kappa$}{$\chi$}{Егор Скурковин}{Никита Терентьев}
}

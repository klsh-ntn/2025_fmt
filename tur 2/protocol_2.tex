...
% пустой протокол для ручного заполнения
% day 0
\protocol{1.1}{$\alpha$}{$\gamma$}{Вика Луковская}{Настя Судницына, Вова Федоров}

\protocol{1.2}{$\eta$}{$\nu$}{Егор Лунев}{Герман Злобин, Рома Лисин}

\protocol{2.1}{$\sigma$}{$\epsilon$}{Миша Красков}{Ольга Володько, Тима Спрыжков}

\protocol{2.2}{o}{$\tau$}{Ваня Карлов}{Вика Фонарева, Саша Тимошков}

\protocol{3.1}{$\phi$}{$\omega$}{Роберт Гринштейн}{Дмитрий Федченко, Лев Назаров}

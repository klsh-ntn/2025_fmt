...
\newcommand{\physB}{
    \begin{minipage}{0.45\linewidth}
        Найди ток текущий через резистор имени Марины Хмельницкой, отмеченный шишкой, в цепи, спаянной Вовой Федоровым в виде фразы \textbf{"IDV-4:5"}, если на клеммы $A$ и $B$ подано напряжение $U = 85$ В.
    \end{minipage}\hfill
    \begin{minipage}{0.55\linewidth}
        \centering{\includegraphics[width=\linewidth]{idv_4-5.jpg}}
    \end{minipage}
}   

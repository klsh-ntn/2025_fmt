...
\newcommand{\physA}{
    Если на верхний конец вертикально расположенной пружины положить груз, то пружина сожмется на расстояние $x_0 = 3$ мм. На сколько изменится длина пружины, если тот же груз упадет на пружину с высоты $h = 8$ см?
}

\newcommand{\physAsol}{
    Кладем груз - находим коэффицент упругости
    \begin{equation*}
        mg = k x_0 \Rightarrow k = \frac{mg}{x_0}
    \end{equation*}
    Кидаем груз
    \begin{equation*}
        mgh = \frac{kx^2}{2} = \frac{mgx^2}{2x_0} \Rightarrow x = \sqrt{2hx_0} = \sqrt{2 \cdot 80 \cdot 3} = 4\sqrt{30}\ \text{мм}
    \end{equation*}
...
\newcommand{\physB}{
    \textbf{свалка, 2011 год (36 сезон)} На столе лежит квадратная книга массы $m$ и стороной длины $l$. Какую минимальную работу нужно совершить, чтобы раскрыть её на середине? Толщина книги много меньше $l$.
}
